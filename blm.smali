...
.method public final a(Ljava/io/File;)Z
    ...
    iget-object v1, p0, Lblm;->a:Liir;

    invoke-interface {v1, p1}, Liir;->c(Ljava/io/File;)Z
    ...
    :cond_2
    :try_start_0
    invoke-static {p1}, Lblm;->b(Ljava/io/File;)Ljava/io/File;
    ...
    iget-object v6, p0, Lblm;->a:Liir;

    invoke-interface {v6, v5}, Liir;->c(Ljava/io/File;)Z

    move-result v6

    if-eqz v6, :cond_4

    invoke-static {v5}, Lblm;->b(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {v4}, Lblm;->b(Ljava/io/File;)Ljava/io/File;
    ...
    :cond_7
    invoke-static {v1}, Lcw;->b(Ljava/io/File;)Z
