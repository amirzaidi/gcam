...
.method protected onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ContentFrameLayout;->h:Lqn;

    if-eqz v0, :cond_3

    iget-object v0, p0, Landroid/support/v7/widget/ContentFrameLayout;->h:Lqn;

    iget-object v0, v0, Lqn;->a:Lkx;

    iget-object v1, v0, Lkx;->o:Lqo;

    if-eqz v1, :cond_0

    iget-object v1, v0, Lkx;->o:Lqo;

    invoke-interface {v1}, Lqo;->j()V

    :cond_0
    iget-object v1, v0, Lkx;->r:Landroid/widget/PopupWindow;

    if-eqz v1, :cond_2

    iget-object v1, v0, Lkx;->c:Landroid/view/Window;

    invoke-virtual {v1}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object v1

    iget-object v2, v0, Lkx;->s:Ljava/lang/Runnable;
    ...
    iput-object v1, v0, Lkx;->r:Landroid/widget/PopupWindow;
    ...
    invoke-virtual {v0, v1}, Lkx;->g(I)Llh;
