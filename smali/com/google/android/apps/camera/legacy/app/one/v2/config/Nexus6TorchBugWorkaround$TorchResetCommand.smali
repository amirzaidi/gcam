.class final Lcom/google/android/apps/camera/legacy/app/one/v2/config/Nexus6TorchBugWorkaround$TorchResetCommand;
...
# direct methods
.method constructor <init>(Lcom/google/android/apps/camera/legacy/app/one/v2/core/FrameServer;Lcom/google/common/util/concurrent/ListenableFuture;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/legacy/app/one/v2/config/Nexus6TorchBugWorkaround$TorchResetCommand;->frameServer:Lcom/google/android/apps/camera/legacy/app/one/v2/core/FrameServer;

    iput-object p2, p0, Lcom/google/android/apps/camera/legacy/app/one/v2/config/Nexus6TorchBugWorkaround$TorchResetCommand;->commonRequestTemplate:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final run()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/one/v2/config/Nexus6TorchBugWorkaround$TorchResetCommand;->frameServer:Lcom/google/android/apps/camera/legacy/app/one/v2/core/FrameServer;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/one/v2/config/Nexus6TorchBugWorkaround$TorchResetCommand;->commonRequestTemplate:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-virtual {v3, v0, v4}, Lcom/google/android/apps/camera/legacy/app/one/v2/core/RequestBuilder;->setParam(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lcom/google/android/apps/camera/legacy/app/one/v2/core/RequestBuilder;
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/android/apps/camera/legacy/app/one/v2/core/RequestBuilder;->setParam(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lcom/google/android/apps/camera/legacy/app/one/v2/core/RequestBuilder;
