.class final Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;
...
.method public constructor <init>(Lcom/google/android/apps/camera/ui/motion/Invalidator;Landroid/graphics/Paint;FF)V
    .locals 2
...
.method public final draw(JJLandroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->ringRadius:Lcom/google/android/apps/camera/ui/motion/DampedSpring;
    ...
    iget v0, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->focusState$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NMOPB7C5HNIBR1E1O2UTB95TJ6UORLECNKCRR3ELPL4QBECT96ARJ4CLP6ASH48PNM6TBJADQ62T357C______0:I
    ...
    iget-wide v2, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->enterStartMillis:J

    long-to-float v2, v2

    iget v3, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->enterDurationMillis:F
    ...
    iput v0, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->focusState$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NMOPB7C5HNIBR1E1O2UTB95TJ6UORLECNKCRR3ELPL4QBECT96ARJ4CLP6ASH48PNM6TBJADQ62T357C______0:I
    ...
    iget-boolean v0, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->exitRequested:Z
    ...
    iput-wide p1, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->exitStartMillis:J
    ...
    iget-wide v2, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->exitStartMillis:J

    long-to-float v2, v2

    iget v3, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->exitDurationMillis:F
    ...
    iget-wide v2, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->hardExitStartMillis:J
    ...
    :cond_3
    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->isActive()Z
    ...
    :cond_4
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->invalidator:Lcom/google/android/apps/camera/ui/motion/Invalidator;

    invoke-interface {v0}, Lcom/google/android/apps/camera/ui/motion/Invalidator;->invalidate()V

    const/16 v0, 0xff

    iget v2, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->focusState$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NMOPB7C5HNIBR1E1O2UTB95TJ6UORLECNKCRR3ELPL4QBECT96ARJ4CLP6ASH48PNM6TBJADQ62T357C______0:I

    sget v3, Lcom/google/android/apps/camera/legacy/app/ui/focus/FocusRingRenderer$FocusState;->STATE_ENTER$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NMOPB7C5HNIBR1E1O2UTB95TJ6UORLECNKCRR3ELPL4QBECT96ARJ4CLP6ASH48PNM6TBJADQ62T357C______0:I

    if-ne v2, v3, :cond_6

    iget-wide v2, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->enterStartMillis:J

    iget v0, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->enterDurationMillis:F

    invoke-static {p1, p2, v2, v3, v0}, Landroid/support/v4/content/res/ConfigurationHelper$ConfigurationHelperImpl;->unitRatio(JJF)F

    move-result v0

    iget-object v2, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->enterOpacityCurve:Lcom/google/android/apps/camera/ui/motion/UnitCurve;
    ...
    :cond_5
    :goto_1
    iget-object v2, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->ringPaint:Landroid/graphics/Paint;

    invoke-virtual {v2, v0}, Landroid/graphics/Paint;->setAlpha(I)V

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->getCenterX()I

    move-result v0

    int-to-float v0, v0

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->getCenterY()I

    move-result v2

    int-to-float v2, v2

    iget-object v3, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->ringPaint:Landroid/graphics/Paint;
    ...
    iget v0, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->exitDurationMillis:F

    invoke-static {p1, p2, v2, v3, v0}, Landroid/support/v4/content/res/ConfigurationHelper$ConfigurationHelperImpl;->unitRatio(JJF)F

    move-result v0

    iget-object v2, p0, Lcom/google/android/apps/camera/legacy/app/ui/focus/AutoFocusRing;->exitOpacityCurve:Lcom/google/android/apps/camera/ui/motion/UnitCurve;
