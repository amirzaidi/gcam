...
.field public final mInactiveLoaders:Lep;

.field public final mLoaders:Lep;
...
.method constructor <init>(Ljava/lang/String;Landroid/support/v4/app/FragmentHostCallback;Z)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Lep;

    new-instance v0, Lep;

    invoke-direct {v0}, Lep;-><init>()V

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Lep;
...
.method private createLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;
    ...
    invoke-interface {p3, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Lbq;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbq;
...
.method public destroyLoader(I)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Lep;

    invoke-virtual {v0, p1}, Lep;->e(I)I
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Lep;

    invoke-virtual {v2, v1}, Lep;->b(I)V

    invoke-virtual {v0}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->destroy()V

    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Lep;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Lep;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v4, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Lep;

    invoke-virtual {v4, v1}, Lep;->c(I)I
    ...
    invoke-virtual {v0, v2}, Lep;->d(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Lep;

    invoke-virtual {v3, v2}, Lep;->c(I)I
...
.method public getLoader(I)Lbq;
    ...
    invoke-static {v2, v3, p1}, Lea;->a([III)I
    ...
    iget-object v1, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbq;
...
.method public initLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Lbq;
    .locals 4
    ...
    iget-object v1, v0, Lep;->c:[I

    iget v2, v0, Lep;->e:I

    invoke-static {v1, v2, p1}, Lea;->a([III)I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Lbq;Ljava/lang/Object;)V

    :cond_4
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbq;
...
.method installLoader(Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;)V
    ...
    invoke-virtual {v0, v1, p1}, Lep;->a(ILjava/lang/Object;)V
...
.method public restartLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Lbq;
    .locals 6
    ...
    invoke-static {v1, v3, p1}, Lea;->a([III)I
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Lep;

    iget-object v3, v1, Lep;->c:[I

    iget v4, v1, Lep;->e:I

    invoke-static {v3, v4, p1}, Lea;->a([III)I

    move-result v3

    if-ltz v3, :cond_3

    iget-object v4, v1, Lep;->d:[Ljava/lang/Object;

    aget-object v4, v4, v3

    sget-object v5, Lep;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v1, p1, v0}, Lep;->a(ILjava/lang/Object;)V
    ...
    :cond_a
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Lep;

    invoke-virtual {v1, p1, v2}, Lep;->a(ILjava/lang/Object;)V
