...
.method constructor <init>(Lgck;Ljava/util/concurrent/Executor;Lefy;ILgce;Lhhz;I)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Legs;-><init>(Lgck;Ljava/util/concurrent/Executor;Lefy;ILgce;)V

    iput-object p6, p0, Legr;->a:Lhhz;
...
.method protected static a(Lgck;)Legu;
    .locals 4

    new-instance v0, Legu;

    iget-object v1, p0, Lgck;->c:Lhhw;

    iget-object v2, p0, Lgck;->b:Lhnz;

    invoke-interface {v2}, Lhnz;->f()I

    move-result v2

    iget-object v3, p0, Lgck;->b:Lhnz;

    invoke-interface {v3}, Lhnz;->c()I

    move-result v3

    invoke-direct {v0, v1, v2, v3}, Legu;-><init>(Lhhw;II)V

    return-object v0
.end method

.method private final a(Lhnz;Landroid/graphics/Rect;IZ)[I
    .locals 33

    invoke-static/range {p1 .. p2}, Legr;->a(Lhnz;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v4, v2}, Legr;->a(II)I
    ...
    invoke-virtual {v0, v3}, Legr;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Legr;->a(Ljava/lang/String;)V
    ...
    invoke-static/range {v1 .. v8}, Legr;->a(IIIIIIII)I
    ...
    invoke-static/range {v9 .. v16}, Legr;->a(IIIIIIII)I
    ...
    invoke-static/range {v15 .. v22}, Legr;->a(IIIIIIII)I
    ...
    invoke-virtual {v0, v1}, Legr;->a(Ljava/lang/String;)V

    return-object v32
.end method

.method private final b(Lhnz;Landroid/graphics/Rect;I)[I
    .locals 40
    ...
    invoke-static {v5, v4}, Legr;->a(II)I
    ...
    invoke-static/range {v2 .. v9}, Legr;->a(IIIIIIII)I
    ...
    invoke-static/range {v10 .. v17}, Legr;->a(IIIIIIII)I
    ...
    invoke-static/range {v16 .. v23}, Legr;->a(IIIIIIII)I
...
# virtual methods
.method protected final a(Lgck;I)Legu;
    .locals 4
    ...
    invoke-static {v0, v1}, Legr;->a(Lhnz;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iget-object v3, p1, Lgck;->c:Lhhw;

    invoke-direct {v2, v3, v1, v0}, Legu;-><init>(Lhhw;II)V
    ...
    invoke-static {v1, v0}, Legr;->a(II)I
...
.method public final a(Legu;[II)V
    .locals 4

    new-instance v0, Legv;

    iget-wide v2, p0, Legr;->e:J

    invoke-direct {v0, v2, v3, p1, p3}, Legv;-><init>(JLegu;I)V

    iget-object v1, p0, Legr;->c:Lefy;
    ...
    invoke-direct {v2, p2}, Legw;-><init>([I)V

    invoke-interface {v1, v0, v2}, Lefv;->a(Legv;Legw;)V
...
.method public a(Ljava/lang/String;)V
    ...
    sget-object v0, Legr;->b:Ljava/lang/String;
...
.method protected final a(Lhnz;Landroid/graphics/Rect;I)[I
    .locals 7
    ...
    invoke-static {v0, v2}, Legr;->a(II)I
    ...
    :pswitch_1
    invoke-static {p1, p2}, Legr;->a(Lhnz;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v3}, Legr;->a(Ljava/lang/String;)V
    ...
    invoke-static {v3, v0}, Legr;->a(II)I
    ...
    invoke-virtual {p0, v1}, Legr;->a(Ljava/lang/String;)V

    goto/16 :goto_0

    :pswitch_2
    invoke-direct {p0, p1, p2, p3}, Legr;->b(Lhnz;Landroid/graphics/Rect;I)[I
    ...
    :pswitch_3
    invoke-direct {p0, p1, p2, p3, v5}, Legr;->a(Lhnz;Landroid/graphics/Rect;IZ)[I
    ...
    :pswitch_4
    invoke-direct {p0, p1, p2, p3, v1}, Legr;->a(Lhnz;Landroid/graphics/Rect;IZ)[I
...
.method public run()V
    ...
    iget-object v2, p0, Legr;->g:Lgck;

    iget-object v0, v2, Lgck;->b:Lhnz;

    iget-object v3, v2, Lgck;->e:Landroid/graphics/Rect;

    invoke-static {v0, v3}, Legr;->a(Lhnz;Landroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v3

    invoke-static {v2}, Legr;->a(Lgck;)Legu;
    ...
    invoke-direct {v4, v0, v5}, Lhhz;-><init>(II)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v2, v0}, Legr;->a(Lgck;I)Legu;

    move-result-object v1

    :try_start_0
    iget-wide v4, p0, Legr;->e:J

    sget v6, Lcb;->ak:I

    invoke-virtual {p0, v4, v5, v1, v6}, Legr;->a(JLegu;I)V

    iget-object v4, v2, Lgck;->b:Lhnz;
    ...
    invoke-virtual {p0, v4}, Legr;->a(Ljava/lang/String;)V

    iget-object v4, v2, Lgck;->b:Lhnz;

    invoke-virtual {p0, v4, v3, v0}, Legr;->a(Lhnz;Landroid/graphics/Rect;I)[I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    move-result-object v0

    iget-object v3, p0, Legr;->c:Lefy;

    iget-object v2, v2, Lgck;->b:Lhnz;

    iget-object v4, p0, Legr;->d:Ljava/util/concurrent/Executor;

    invoke-interface {v3, v2, v4}, Lefy;->a(Lhnz;Ljava/util/concurrent/Executor;)V

    sget v2, Lcb;->ak:I

    invoke-virtual {p0, v1, v0, v2}, Legr;->a(Legu;[II)V
    ...
    invoke-static {v4, v0}, Lbry;->c(II)Z
    ...
    invoke-static {v4, v0}, Lbry;->a(Lhhz;Lhhz;)I
    ...
    iget-object v3, p0, Legr;->d:Ljava/util/concurrent/Executor;
