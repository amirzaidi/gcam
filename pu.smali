...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Lpu;->c:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v0, p2}, Lpu;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lpu;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lpu;->a:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    iput-object v1, p0, Lpu;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lpu;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lpu;->b:[I

    invoke-static {v0, p1, v1, p2, v3}, Luj;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Luj;

    move-result-object v4

    invoke-virtual {v4, v3}, Luj;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v5, p0, Lpu;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lpu;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {v4, v9}, Luj;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v1, p0, Lpu;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lpu;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
